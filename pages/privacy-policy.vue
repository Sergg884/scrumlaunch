<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Scrumlaunch LLC, 301 w 23rd Street Vancouver
          WA 98660.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Scrumlaunch, accessible from
          <a
            href="https://www.scrumlaunch.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.scrumlaunch.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: hello@scrumlaunch.com</li>
    </ul>
  </div>
</template>
